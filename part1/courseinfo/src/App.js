...
const Part1 = props => <p>{props.part1.name} {props.part1.exercises}</p>

const Part2 = props => <p>{props.part2.name} {props.part2.exercises}</p>

const Part3 = props => <p>{props.part3.name} {props.part3.exercises}</p>
